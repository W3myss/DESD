...
class Event(models.Model):
    ...
    location = models.CharField(max_length=255, blank=True, null=True)  # For in-person events
    virtual_link = models.URLField(blank=True, null=True)  # For virtual events
